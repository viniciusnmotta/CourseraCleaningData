# Assignment Project: Coursera Getting and Cleaning Data Course
...
4. Then run the r_analysis.R. One table (.txt files) will be saved in your working directory:  1) a text file containing all measurements with descriptive variables names and the counts and the average of each variable for each activity for each subject (HumanActivityMeasure.txt).
